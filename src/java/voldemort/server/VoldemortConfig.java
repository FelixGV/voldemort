...
public class VoldemortConfig implements Serializable {
    ...
    public VoldemortConfig(Props props) {
        ...
        this.modifiedProtocol = props.getString(READONLY_MODIFY_PROTOCOL);
        this.modifiedPort = props.getInt(READONLY_MODIFY_PORT);
        this.bouncyCastleEnabled = props.getBoolean(USE_BOUNCYCASTLE_FOR_SSL);
